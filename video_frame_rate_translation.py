...
def createAllVideoFrameRateTranslation(dataset_top_dir):
    ...
    for _dir_ in rec_dir_list:
        all_timestamps, pv_timestamps = createSingleFrameRateTranslation(_dir_)
...
if __name__ == "__main__":
    dataset_dir = r'D:\test_recordings\Table_None_Paul_18092022_1216_recDir'
    trans = createSingleFrameRateTranslation(dataset_dir)
    print(trans[138])
