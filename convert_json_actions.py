...
# dataset_path = 'C:\TinyDataset\indexing_files'
dataset_path = r'D:\HoloLens\indexing_files'
json_path = os.path.join(dataset_path, 'db_gt_annotations.json')
bkp_path = os.path.join(dataset_path, 'old_db_gt_annotations.json')
